...
data["CEmissReduce"] = data["CEmissReduce"].apply(lambda x: np.log10(x + 1))
data["CEmission"] = data["CEmission"].apply(lambda x: np.log10(x + 1))
data["SC_CC"] = data["SC_CC"]
data["SC_PC"] = data["SC_PC"]
data["SC_CCHHI"] = data["SC_CCHHI"]
data["SC_PCHHI"] = data["SC_PCHHI"]
data["SC_SCC"] = data["SC_SCC"]
